...
public class PatientService {
    private static final String STORAGE_PATH = "C:/mediease/uploads/"; // Change this path as needed
     ...
     */
    public String storeFile(String email, MultipartFile file) throws Exception {
        ...
        // Check file limit
        int totalFiles = getAllFileNames(folderPath).size();
     ...
     */
    private Patients getPatientByEmail(String email) {
        Optional<Users> user = userRepository.findByEmail(email);

        return user.map(Users::getPatient).orElse(null);
    }
}
